...
<form class="jotform-form" action="/form-templates/preview/thank-you/classic" method="get" name="form_43084276238963" id="43084276238963" accept-charset="utf-8">
...
<label class="form-label form-label-top" id="label_4" for="input_4_area">
Phone Number
<span class="form-required">
*
</span>
...
<span class="form-sub-label-container " style="vertical-align:top">
<input type="tel" id="input_4_phone" name="q4_phoneNumber4[phone]" class="form-textbox validate[required]" size="12" value="" data-component="phone" aria-labelledby="label_4 sublabel_4_phone" required="" />
<label class="form-sub-label" for="input_4_phone" id="sublabel_4_phone" style="min-height:13px"> Phone Number </label>
</span>
</div>
</div>
</li>
<li class="form-line form-line-column form-col-1 jf-required" data-type="control_datetime" id="id_5">
<label class="form-label form-label-top" id="label_5" for="month_5">
Reservation Date
<span class="form-required">
*
</span>
...
<li class="form-line form-line-column form-col-2" data-type="control_time" id="id_8">
<label class="form-label form-label-top" id="label_8" for="input_8_hourSelect"> Reservation Time </label>
...
<label class="form-label form-label-top" id="label_9" for="input_9"> Notes (optional) </label>
