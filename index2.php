...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      <li class="nav-item active">
        <a class="nav-link" href="index2.php"><i style='font-size:24px' class='fas'>&#xf015;</i> Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="commande/index.php">Commandes</a>
          <a href="#reservation" class="dropdown-item" href="ssc.php">Reservation</a>
        
      </li>
      <li class="nav-item">
        <a class="nav-link " href="unserinfo.php" ><i style='font-size:24px' class='fas'>&#xf095;</i>Contact</a>
      </li>
       ...
       <li class="nav-item" style="margin-top: -20px;">
        <div class="btn-group dropleft">
          ...
          <div class="dropdown-menu">
            ...
            <div style="background-color: white"><center><?php echo " Welcome<p>".$_SESSION['UserName']."</p>"?></center></div>
         <a href="Deconnection.php"><button  type="button" class="btn btn-secondary" style="background-color: blue">Deconnexion</button></a>   
        </div>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/image1.jpg"  width="1100" height="500">
      <div class= "carousel-caption">
        <h3><i>Welcome to the Greatest Restaurant</i></h3>
      </div>
    </div>
    <div class="carousel-item">
      <img src="images/image2.jpg"  width="1100" height="500">
      <div class= "carousel-caption">
        <h3><i>Welcome to the Greatest Restaurant</i></h3>
      </div>
    </div>
    <div class="carousel-item">
      <img src="images/image9.jpg"   width="1100" height="500">
      <div class= "carousel-caption">
        <h3><i>Welcome to the Greatest Restaurant</i></h3>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 to-animate-2">
           ...
           <div class="form-group">
            ...
            <div class="form-group ">
              <input class="btn btn-primary" value="Send Message" type="submit" name="submit">
            </div></form>
            </div>
        </div>
      </div>
