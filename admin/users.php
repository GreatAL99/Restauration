              ...
              <div class="panel-body">
                ...
                <table class="table table-striped table-hover">
                      ...
                      $result=$db->prepare($sql);
                       ...
                       if($j=$result->rowCount()>0){
                          $i=0;
                          
                          $row=$result->fetchAll();
                             while($i<$j+1){
                               echo "<tr><td>".$row[$i]["FirstName"]."</td><td>".$row[$i]["LastName"]."</td><td>".$row[$i]["UserName"]."</td><td>".$row[$i]["Email"]."</td><td>".$row[$i]["Password"]."</td></tr>";
                                $i++;
                          }
                   }
                     echo "</table>";
                   ...
                   ?> 
                        <tr>
                        <td><a class="btn btn-default" href="edit.php">Edit</a> <a class="btn btn-danger" href="#">Delete</a></td></tr>
